...
const SpeedingPage = () => {
  ...
  return (
    ...
    >
      <Image
        style={[styles.navebarIcon, styles.iconPosition1]}
        contentFit="cover"
      ...
      <View style={[styles.warningmessage, styles.i95Position]}>
        ...
        />
        <Text
          style={[styles.youAreSpeedingPleaseContainer, styles.i95Position]}
        >
          <Text>
            ...
            <Text style={styles.speeding}>
              <Text style={styles.speeding1}>speeding</Text>
            </Text>
          </Text>
          <Text>
            <Text style={styles.speeding}>
